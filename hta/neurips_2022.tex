...
the GGA in \Cref{sec:addtl_eg}. Note that Inverse Gamma (``IG'') corresponds
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figures/de_normal_sum.png}
	\includegraphics[width=.6\textwidth]{figures/vi_normal_sum.png}
