...
Parts of this chapter were first presented in \fullcite{ftvi}.
% \end{abstract}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics{ftvi/Figures/pancake.pdf}
  \caption{
...
In fact, we can show a version of \Cref{thm:distn_class_closed} ensuring closure of exponential-type
...
\begin{figure*}[htbp]
  \centering
  \includegraphics{ftvi/Figures/radial-fat-tail.pdf}%
  %   \includegraphics[trim={0 0 7cm 0},clip]{ftvi/Figures/radial-fat-tail.pdf}\\%
  %   \includegraphics[trim={7.2cm 0 0 0},clip]{ftvi/Figures/radial-fat-tail.pdf}%
  %\includegraphics[width=\textwidth]{ftvi/Figures/radial-fat-tail.png}%
  %\input{ftvi/Figures/radial-fat-tail.pgf}
  \caption{
...
% \begin{figure}[htbp]
%   \centering
%   \includegraphics[width=0.4\textwidth]{ftvi/Figures/studentt-product.png}
%   \caption{
...
\subsubsection{Anisotropic tail adaptive flows}
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.6\textwidth]{ftvi/Figures/hill.png}
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.9\textwidth]{ftvi/Figures/our-estimator.png}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics{ftvi/Figures/blr_aniso.pdf}
  \caption{
...
\begin{table*}[htbp]
  \centering
  %   \includegraphics[width=1.0\textwidth]{ftvi/Figures/eight_schools.png}
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.9\textwidth]{ftvi/Figures/blr.png}
